    ...
    for epoch in range(epoch_num):
        ...
        for image, (boxes, classes) in tqdm(dataset, total=image_count, desc=f"Epoch {epoch + 1}/{epoch_num}"):
            ...
            with tf.GradientTape() as tape:
                ...
                reshaped_classes = tf.tile(one_hot_classes, [1, student_prediction_dict['class_predictions_with_background'].shape[1]])
                ...
                localization_loss = localization_loss_fn(boxes, student_prediction_dict['box_encodings'])
