...
ckpt.save(distilled_model_path + student_model_name + '_old/ckpt')
print(f"Model {student_model_name} saved in {distilled_model_path + student_model_name + '_old/ckpt'}")